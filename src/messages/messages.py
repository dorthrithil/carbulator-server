...
CANNOT_CHANGE_TOUR_END_KM_WHEN_ANOTHER_TOUR_ALREADY_STARTED = 'CANNOT_CHANGE_TOUR_END_KM_WHEN_ANOTHER_TOUR_ALREADY_STARTED'
CANNOT_UPDATE_UNFINISHED_TOURS = 'CANNOT_UPDATE_UNFINISHED_TOURS'
